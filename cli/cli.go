/*
 * Go Youtube API Example From
 * https://developers.google.com/youtube/v3/code_samples/go#retrieve_my_uploads
 */
...
import (
	...
	yt "github.com/lemonase/youtube-meme-api/wrappers/youtube"
...
func main() {
	...
	for _, playlist := range response.Items {
		...
		fmt.Println(datePublished, "	", playlistId, ": ", playlistTitle, videoCount)
	}
}
